...
//
//	KASの諸設定を指定するクラス
//	このファイルの内容を変更することで KAS をカスタマイズできます
//------------------------------------------------------------------
public class Config
{
	//-------------------------------------------------- リソース関連の設定 ----
	...
	public static final void Util_config()
	{
		...
		// "" を指定すると、<SDカード>/Android/data/<パッケージ名>/files/ になります。
	...
	public static final void History_config(History h, MokaScript moka)
	{
		...
		// ◆ 閉じるボタンの設定
		// 閉じるボタンの設定をします。
		h.closeFilename = "history_close.png";	// 画像
		h.closeWidth = 50;	// ボタンの幅
		h.closeHeight = 50;	// ボタンの高さ
		h.closeLeft = 730;	// 左位置
		h.closeTop = 10;	// 上位置
		...
		// ◆ 前のページボタンの設定
		// 前のページボタンの設定をします。
		h.prevFilename = "history_prev.png";	// 画像
		h.prevPageWidth = 50;	// ボタンの幅
		h.prevPageHeight = 50;	// ボタンの高さ
		h.prevPageLeft = 730;	// 左位置
		h.prevPageTop = 60;		// 上位置


		// ◆ 次のページボタンの位置
		// 次のページボタンの設定をします。
		h.nextFilename = "history_next.png";	// 画像
		h.nextPageWidth = 50;	// ボタンの幅
		h.nextPageHeight = 50;	// ボタンの高さ
		h.nextPageLeft = 730;	// 左位置
		h.nextPageTop = 390;	// 上位置
