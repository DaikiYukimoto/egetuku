...
public class Util
{
	...
	static public final void setRootDirctory(String packageName)
	{
		...
		if(rootDirectoryPath_user.length() == 0)
			rootDirectoryPath = sdcard + "Android/data/" + packageName + "/files";
		else
	...
	static public final void error(String message)
	{
		...
		if(mainView != null) mainView.stopConductor();
		log("Error! " + message);
	 ...
	 */
	static public void showUrl(String url)
	{
	...
	/**
	 * SD カードの存在確認
	 * @return SD カードがあるなら true
	 */
	static public boolean mountedSd()
	{
